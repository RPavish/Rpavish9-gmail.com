...
<html>
<head>
    <title>Your Name - R.pavish</title>
    <style>
        body {
...
<body>
    <header>
        <div class="header-content">
            <img src="IMG/pavsih.jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>PAVISH R</h1>
            <p></p>
        </div>
    </header>
    ...
    <section id="about">
        <div class="section-content">
            <h2>About Me</h2>
            <p>I am Pavish and I'm seeking for a challenging career opportunity in a computer technology field.I really enjoy to build a coding.</p>
        </div>
    </section>
